...
import { usePlatformAuthenticator } from '~/hooks/usePlatformAuthenticator'
  ...
  if (!isPlatformAuthenticatorAvailable) {
    return (
      <>
        ...
        <div className="flex h-full flex-col items-center justify-center gap-y-4 rounded-xl">
          <p className="text-center font-[500] text-[31px]">Uh-oh!</p>
          <div className="h-2" />
          <p className="max-w-[24ch] text-center text-[18px] text-base text-gray11 tracking-[-2.8%]">
            It seems like your device doesn't support Passkeys. Please try
            accessing RISE Wallet on a compatible device.
          </p>
        </div>
